...
void media_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (media_tap_state.state) {
        ...
        case TD_SINGLE_HOLD: register_code(KC_MSTP); break;
        case TD_DOUBLE_TAP: register_code(KC_MNXT); break;
        case TD_DOUBLE_HOLD: register_code(KC_MPRV); break;
        // Last case is for fast typing. Assuming your key is `f`:
        // For emedia_ample, when typing the word `buffer`, and you want to make sure that you send `ff` and not `Esc`.
...
void media_reset(tap_dance_state_t *state, void *user_data) {
    switch (media_tap_state.state) {
        ...
        case TD_SINGLE_HOLD: unregister_code(KC_MSTP); break;
        case TD_DOUBLE_TAP: unregister_code(KC_MNXT); break;
        case TD_DOUBLE_HOLD: unregister_code(KC_MPRV); break;
