...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_92(
     ...
     _______, MO(__MOTION), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,
    ...
    _______,      _______,  _______, _______,  KC_END,   _______,  _______,  _______,  KC_PGUP,  _______,  KC_PGDN,  KC_UP,    _______,  _______,     _______, KC_VOLD,  KC_MSTP,  KC_VOLU,
    _______,      _______,  KC_HOME, _______,  _______,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, _______,  _______,               _______,
