...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_92(
     KC_MUTE,     KC_ESC,             KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,     KC_F12,   _______,  _______,  RGB_TOG,
                                KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,     KC_BSPC,  TD(TD_INS_PRV),   TD(TD_HOME_PLY),  TD(TD_PGUP_NXT),
                                _______,     KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,    KC_BSLS,  KC_DEL,   TD(TD_END_STP),   KC_PGDN,
     _______, TD(TD_SUPER_CTRL), KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,
    ...
    [MAC_FN] = LAYOUT_ansi_92(
     RGB_TOG,     _______,            KC_BRID,  KC_BRIU,  KC_MCTL,  KC_LPAD,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,    KC_VOLU,  KC_SNAP,  KC_SIRI,  RGB_MOD,
    ...
    [__MOTION] = LAYOUT_ansi_92(
    _______,      QM_STLK,           KC_BRID,  KC_BRIU,  _______,  _______,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,     KC_VOLU, _______,  _______,  _______,
    ...
    _______,      _______,  _______, _______,  KC_END,   _______,  _______,  _______,  KC_PGUP,  KC_UP,    _______,  KC_UP,    _______,  _______,     _______, KC_VOLD,  KC_MSTP,  KC_VOLU,
    _______,      _______,  KC_HOME, _______,  KC_PGDN,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, _______,  _______,               _______,
    _______,      _______,           _______,  _______,  _______,  _______,  KC_DOWN,  KC_END,   _______,  _______,  _______,  _______,               _______,           KC_MS_U,
    _______,      _______,  _______, _______,                                KC_BTN1,                                _______,  _______,  _______,     KC_BTN3, KC_MS_L,  KC_MS_D,  KC_MS_R),
};
